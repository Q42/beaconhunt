...
ReactiveBeaconRegion = function(beaconRegion, disableMonitoring, disableRanging) {
    ...
    // Start ranging.
    if (!disableRanging) {
        console.log('starting ranging ' + JSON.stringify(targetBeaconRegion));
    ...
    // start monitoring
    if (!disableMonitoring) {
        console.log('starting monitoring ' + JSON.stringify(targetBeaconRegion));
...
ReactiveBeaconRegion.prototype.getBeaconRegion = function() {
    this.dep.depend();
    console.log('getbeaconregion ' + JSON.stringify(this.beaconRegion));
